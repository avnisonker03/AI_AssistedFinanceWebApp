...
import { createBrowserRouter, createRoutesFromChildren, RouterProvider, Route, Navigate } from 'react-router-dom'
...
import GoogleAuthSuccess from './components/login/GoogleAuthSuccess.jsx'
...
const router = createBrowserRouter(createRoutesFromChildren(
  <Route path='/' element={<App />}>
    ...
    <Route path="/auth/google/error" element={<Navigate to="/login?error=google" />} />
  </Route>
))

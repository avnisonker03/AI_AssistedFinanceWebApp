...
export default function DeleteAbudget({ isOpen, onClose, onSuccess, budgetId, budgetName }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const deleteAction=await axios.delete(
        API_ENDPOINTS.deleteBudget(budgetId),
        {
    ...
    <div className="fixed inset-0 bg-gray-900/80 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-xl w-full max-w-md p-6 relative animate-in fade-in duration-200">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-semibold text-red-400 mb-2">Delete Budget</h2>

...
import { LineChart, BarChart, Wallet, CreditCard, DollarSign, TrendingUp, AlertTriangle, PieChart, ChevronDown } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const processChartData = (data) => {
    ...
    if (trendsData.length < 3) {
      const baseIncome = data.income.totalMonthlyIncome || 20000;
      const baseExpense = data.expenses.totalMonthlyExpenses || 15000;
    ...
    if (data.trends && data.trends.dailyExpenses && data.trends.dailyExpenses.length > 0) {
      ...
      const monthlyExpense = data.expenses.totalMonthlyExpenses || 15000;
    ...
    if (data.trends && data.trends.dailyExpenses) {
      ...
      if (methodsMap.size === 0) {
        const totalExpense = data.expenses.totalMonthlyExpenses || 15000;
